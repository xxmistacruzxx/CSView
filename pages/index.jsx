          ...
          <div>
            ...
            <div className={styles.featureBoxesContainer}>
              <a href="/#search">
                ...
                <p>
                  Lookup an individual player by their username or SteamID to
                  see their stats and match history.
                </p>
              </a>
              <a href="/#multisearch">
          ...
          <div id="crosshairs">
            <div className={styles.featureContent}>
              ...
              <p>
                ...
                <br />
                <br />
                Use the crosshair repository to browse and copy crosshairs used
